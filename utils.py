                ...
                for j in range(dim + 1):
                    ...
                    if maze_matrix[i][j][0]:
                        if i > 0 and j < dim and maze_matrix[i - 1][j + 1][1]:
                            window.draw_rect(x_cor + cell_size, y_cor, border_width // 2, border_width // 2, border_color)
                        if i > 0 and maze_matrix[i - 1][j][1]:
                            window.draw_rect(x_cor - border_width // 2, y_cor, border_width // 2, border_width // 2, border_color)
                    ...
                    if maze_matrix[i][j][1]:
                        ...
                        if j > 0 and maze_matrix[i][j - 1][0]:
                            window.draw_rect(x_cor, y_cor - border_width // 2, border_width // 2, border_width // 2, border_color)
        ...
        def draw_shadows():
            for i in range(dim + 1):
                for j in range(dim + 1):
                    ...
                    if j < dim:
                        window.draw_rect(x_cor, y_cor - shadow_width // 2, cell_size, shadow_width, shadow_color)
                    if i < dim:
                        window.draw_rect(x_cor - shadow_width // 2, y_cor, shadow_width, cell_size, shadow_color)
        ...
        def draw_borders():
            for i in range(dim + 1):
                for j in range(dim + 1):
                    ...
                    if maze_matrix[i][j][0]:
                        window.draw_rect(x_cor, y_cor - border_width // 2, cell_size, border_width, border_color)
                    if maze_matrix[i][j][1]:
                        window.draw_rect(x_cor - border_width // 2, y_cor, border_width, cell_size, border_color)
